...
\begin{itemize}
	\item Como utilizar as inspeções e testes unitários, que são práticas complementares da Verificação de \textit{Software}, em conjunto com os princípios oriundos da VBSE, na avaliação da qualidade de código no contexto do desenvolvimento ágil?
\end{itemize}
...
\begin{itemize}
	...
	\item Incorporar princípios propostos pela Engenharia de \textit{Software} Baseada em Valor ao \textit{framework}.
\end{itemize}
