...
A figura \ref{fig:evolucaoPortal} exibe dois gráficos comparativos, \textit{sprint} 1 e \textit{sprint} 2, que evidenciam as percepções dos desenvolvedores do Portal quanto ao uso do \textit{framework}.
